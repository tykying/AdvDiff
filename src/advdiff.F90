...
!     write(6, "(a,"//int_chr//","//int_chr//")") "  size(jumps(2)%alpha_i, 1:2)", size(jumps(2)%alpha_i, 1), size(jumps(2)%alpha_i, 2)
  ...
  subroutine unittest_simulate_trajdata()
    ...
    write(6, "(a,"//dp_chr//","//dp_chr//","//dp_chr//","//dp_chr//","//dp_chr//")") "|  exact = ", x_exa, y_exa, xx_exa, yy_exa, xy_exa
    write(6, "(a,"//dp_chr//","//dp_chr//","//dp_chr//","//dp_chr//","//dp_chr//")") "|  computed = ", x_bar, y_bar, xx_bar, yy_bar, xy_bar
...
!     character(len = *), parameter :: RunProfile = "QGM2_L1_NPART676"
    ...
    dt = 3.0_dp*3600.0_dp  ! 2 hours, in seconds
